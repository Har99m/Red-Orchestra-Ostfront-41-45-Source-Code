...
defaultproperties
{
     PassengerWeapons(0)=(WeaponPawnClass=Class'ROVehicles.PanzerIIICannonPawn_Striped')
     PassengerWeapons(1)=(WeaponPawnClass=Class'ROVehicles.PanzerIIIMountedMGPawn_Striped')
