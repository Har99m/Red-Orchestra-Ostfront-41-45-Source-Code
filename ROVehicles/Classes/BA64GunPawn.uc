...
defaultproperties
{
     FirstPersonGunShakeScale=3.000000
     DriverPositions(0)=(ViewFOV=85.000000,PositionMesh=SkeletalMesh'allies_ba64_anm.BA64_turret_int',TransitionUpAnim="com_open",DriverTransitionAnim="VBA64_com_close",ViewPitchUpLimit=3500,ViewPitchDownLimit=63500,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000)
     DriverPositions(1)=(ViewFOV=85.000000,PositionMesh=SkeletalMesh'allies_ba64_anm.BA64_turret_int',TransitionDownAnim="com_close",DriverTransitionAnim="VBA64_com_open",ViewPitchUpLimit=3500,ViewPitchDownLimit=63500,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000,bExposed=True)
     bMultiPosition=True
