...
defaultproperties
{
     ...
     bUsesTracers=True
     VehHitpoints(0)=(PointRadius=9.000000,PointScale=1.000000,PointBone="com_attachment",PointOffset=(X=6.000000,Y=-6.000000,Z=22.000000))
     VehHitpoints(1)=(PointRadius=15.000000,PointScale=1.000000,PointBone="com_attachment",PointOffset=(X=4.000000,Y=-5.000000,Z=2.000000))
     ...
     AmbientEffectEmitterClass=Class'ROVehicles.VehicleMGEmitterUC'
