...
defaultproperties
{
     ...
     PassengerWeapons(0)=(WeaponPawnClass=Class'ROVehicles.PanzerIVF2CannonPawn',WeaponBone="Turret_placement")
     PassengerWeapons(1)=(WeaponPawnClass=Class'ROVehicles.PanzerIVF2MountedMGPawn',WeaponBone="Mg_placement")
     ...
     DestroyedVehicleMesh=StaticMesh'axis_vehicles_stc.Panzer4F2.Panzer4F2_Destroyed'
     ...
     DriverPositions(0)=(PositionMesh=SkeletalMesh'axis_panzer4F2_anm.Panzer4F2_body_int',TransitionUpAnim="Overlay_Out",ViewPitchUpLimit=1,ViewPitchDownLimit=65535,bDrawOverlays=True)
     DriverPositions(1)=(PositionMesh=SkeletalMesh'axis_panzer4F2_anm.Panzer4F2_body_int',TransitionUpAnim="driver_hatch_open",TransitionDownAnim="Overlay_In",DriverTransitionAnim="VPanzer4_driver_close",ViewPitchUpLimit=5000,ViewPitchDownLimit=61000,ViewPositiveYawLimit=5000,ViewNegativeYawLimit=-10000)
     DriverPositions(2)=(PositionMesh=SkeletalMesh'axis_panzer4F2_anm.Panzer4F2_body_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="VPanzer4_driver_open",ViewPitchUpLimit=5000,ViewPitchDownLimit=65536,ViewPositiveYawLimit=19000,ViewNegativeYawLimit=-20000,bExposed=True,ViewFOV=85.000000)
     ...
     VehHitpoints(0)=(PointRadius=10.000000,PointOffset=(X=-7.000000,Z=7.000000))
