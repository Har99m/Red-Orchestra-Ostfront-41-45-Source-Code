...
defaultproperties
{
     ...
     FastCursorStep=1
     CursorStep=1
     MouseOverSound=Sound'ROMenuSounds.Generic.msfxDown'
     ClickSound=Sound'ROMenuSounds.Generic.msfxMouseClick'
     EditSound=Sound'ROMenuSounds.Generic.msfxEdit'
     UpSound=Sound'ROMenuSounds.Generic.msfxUp'
     DownSound=Sound'ROMenuSounds.Generic.msfxDown'
