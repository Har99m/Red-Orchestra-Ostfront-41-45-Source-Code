...
defaultproperties
{
     ...
     ExplosionSounds(0)=Sound'Vehicle_Weapons.Hits.vehicle_explode01'
     ExplosionSounds(1)=Sound'Vehicle_Weapons.Hits.vehicle_explode02'
     ...
     ImpactDamageSounds(0)=SoundGroup'Vehicle_Engines.bottoming_out.bottom_out'
     ...
     BulletSounds(0)=SoundGroup'ProjectileSounds.Bullets.Impact_Metal'
