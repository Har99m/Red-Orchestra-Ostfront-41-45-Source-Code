...
defaultproperties
{
     ...
     DistantSound(0)=SoundGroup'Artillery.zoomin.fire_distant'
     DistantSound(1)=SoundGroup'Artillery.zoomin.fire_distant'
     DistantSound(2)=SoundGroup'Artillery.zoomin.fire_distant'
     DistantSound(3)=SoundGroup'Artillery.zoomin.fire_distant'
     CloseSound(0)=SoundGroup'Artillery.zoomin.zoom_in01'
     CloseSound(1)=SoundGroup'Artillery.zoomin.zoom_in02'
     CloseSound(2)=SoundGroup'Artillery.zoomin.zoom_in03'
     CloseSound(3)=SoundGroup'Artillery.zoomin.zoom_in03'
