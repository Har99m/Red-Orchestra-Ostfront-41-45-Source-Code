...
defaultproperties
{
     ...
     SoundFootsteps(0)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     SoundFootsteps(1)=SoundGroup'Inf_Player.footsteps.FootstepGravel'
     SoundFootsteps(2)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     SoundFootsteps(3)=SoundGroup'Inf_Player.footsteps.FootstepMetal'
     SoundFootsteps(4)=SoundGroup'Inf_Player.footsteps.FootstepWoodenfloor'
     SoundFootsteps(5)=SoundGroup'Inf_Player.footsteps.FootstepGrass'
     SoundFootsteps(6)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     SoundFootsteps(7)=SoundGroup'Inf_Player.footsteps.FootstepSnowRough'
     SoundFootsteps(8)=SoundGroup'Inf_Player.footsteps.FootstepSnowHard'
     SoundFootsteps(9)=SoundGroup'Inf_Player.footsteps.FootstepWaterShallow'
     SoundFootsteps(10)=SoundGroup'Inf_Player.footsteps.FootstepGravel'
     SoundFootsteps(11)=SoundGroup'Inf_Player.footsteps.FootstepGravel'
     SoundFootsteps(12)=SoundGroup'Inf_Player.footsteps.FootstepAsphalt'
     SoundFootsteps(13)=SoundGroup'Inf_Player.footsteps.FootstepWoodenfloor'
     SoundFootsteps(14)=SoundGroup'Inf_Player.footsteps.FootstepMud'
     SoundFootsteps(15)=SoundGroup'Inf_Player.footsteps.FootstepMetal'
     SoundFootsteps(16)=SoundGroup'Inf_Player.footsteps.FootstepAsphalt_P'
     SoundFootsteps(17)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     SoundFootsteps(18)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     SoundFootsteps(19)=SoundGroup'Inf_Player.footsteps.FootstepDirt'
     ...
     RagImpactSound=SoundGroup'Inf_Player.RagdollImpacts.BodyImpact'
     ...
     CrouchToProneSound=SoundGroup'Inf_Player.stances.crouch_to_prone'
     CrouchToStandSound=SoundGroup'Inf_Player.stances.crouch_to_stand'
     ProneToCrouchSound=SoundGroup'Inf_Player.stances.prone_to_crouch'
     ProneToStandSound=SoundGroup'Inf_Player.stances.prone_to_stand'
     StandToCrouchSound=SoundGroup'Inf_Player.stances.stand_to_crouch'
     StandToProneSound=SoundGroup'Inf_Player.stances.stand_to_prone'
     BreatheLightSound=Sound'Inf_Player.breathe.breathe_light'
     BreatheMediumSound=Sound'Inf_Player.breathe.breathe_medium'
     BreatheHeavySound=Sound'Inf_Player.breathe.breathe_heavy'
     BreatheExhaustedSound=Sound'Inf_Player.breathe.breathe_nostamina'
