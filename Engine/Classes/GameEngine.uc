...
defaultproperties
{
     ...
     ServerPackages(14)="ROGame"
     ServerPackages(15)="ROAmmo"
     ServerPackages(16)="ROInventory"
     ServerPackages(17)="ROInterface"
     ServerPackages(18)="RORoles"
     ServerPackages(19)="AHZ_ROVehicles"
     ServerPackages(20)="ROCustom"
