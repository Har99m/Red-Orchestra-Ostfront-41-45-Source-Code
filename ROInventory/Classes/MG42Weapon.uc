...
defaultproperties
{
     ...
     ROBarrelClass=Class'ROInventory.MG42Barrel'
     ...
     FireModeClass(0)=Class'ROInventory.MG42Fire'
     ...
     PickupClass=Class'ROInventory.MG42Pickup'
     BobDamping=1.600000
     AttachmentClass=Class'ROInventory.MG42Attachment'
