...
defaultproperties
{
     ...
     FireModeClass(0)=Class'ROInventory.PanzerFaustFire'
     ...
     PickupClass=Class'ROInventory.PanzerFaustPickup'
     BobDamping=1.600000
     AttachmentClass=Class'ROInventory.PanzerFaustAttachment'
